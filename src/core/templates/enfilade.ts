...
export const enfiladeTemplate: SceneTemplate = {
  ...
  architecture: {
    ...
    plinths: [
      { position: [0, 0, -6.4], size: [0.5, 0.92, 0.5] },
      { position: [2.55, 0, 0.15], size: [0.44, 0.32, 0.44] },
    ],
    benches: [
      {
        position: [0, 0, 0.2],
    ...
    glbProps: [
      { model: "bust", position: [0, 0.92, -6.4], scale: 1.05 },
      { model: "vase", position: [2.55, 0.32, 0.15], scale: 0.82 },
      { model: "plant", position: [3.15, 0, 7.35], scale: 1.22, yaw: -0.4 },
      { model: "plant", position: [-3.15, 0, 7.35], scale: 1.18, yaw: 0.7 },
      { model: "plant", position: [3.85, 0, -8.35], scale: 1.28, yaw: 0.35 },
      { model: "plant", position: [-3.85, 0, -8.35], scale: 1.25, yaw: 1.05 },
      { model: "plant", position: [3.35, 0, 0.15], scale: 1.08, yaw: -0.8 },
    ],
    signs: [
      {
        text: "ENFILADE",
        subtitle: "Three rooms in procession",
        position: [0, 3.05, -9.42],
        yaw: 0,
        width: 4.2,
        height: 0.72,
        style: "wall",
      ...
      {
        text: "Enfilade",
        subtitle: "Entry · middle · end hall",
        position: [0, 0, 8.05],
        yaw: Math.PI,
        width: 1.15,
        height: 0.4,
