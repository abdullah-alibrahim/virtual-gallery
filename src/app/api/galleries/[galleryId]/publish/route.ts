...
import { publishGallery } from "@/infrastructure/publish/publish-gallery";
...
export async function POST(
  ...
  try {
    ...
    if (error instanceof SceneInvalidError) {
    ...
    console.error("[api/galleries/publish] failed", error);
